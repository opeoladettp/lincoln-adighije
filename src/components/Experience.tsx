  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center">
        ...
        >
          <WorkIcon style={{ color: item.color, fontSize: 14 }} />
        </motion.div>
      ...
      <motion.div
        ...
        className="card rounded-xl p-3 mb-3 flex-1"
      >
        <div className="flex flex-wrap items-start justify-between gap-1 mb-1">
          <div>
            <h3 className="font-bold text-sm" style={{ color: 'var(--text-primary)' }}>{item.role}</h3>
            <p className="text-xs font-medium" style={{ color: item.color }}>{item.company}</p>
          </div>
          <span
        ...
        <p className="text-xs mb-2 leading-relaxed" style={{ color: 'var(--text-muted)' }}>{item.description}</p>
  ...
  return (
    <section id="experience" className="py-16 px-4 sm:px-6 lg:py-0" ref={sectionRef}>
      <div className="max-w-6xl mx-auto w-full" ref={ref}>
        ...
        {/* Two-column timeline on large screens */}
